      ...
      <section className="relative overflow-hidden py-24 md:py-36 bg-white">
        ...
        <div className="relative max-w-[1280px] mx-auto px-4 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <a
              href="https://cal.com/reveal-rank"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-gray-900 hover:bg-gray-800 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all hover:scale-105 shadow-lg shadow-gray-200"
            >
