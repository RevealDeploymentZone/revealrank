  ...
  return (
    <>
        ...
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">{loc.description}</p>
              <p className="text-gray-600 leading-relaxed mb-6">{loc.marketInsight}</p>
            ...
            <div className="space-y-4">
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <h3 className="text-gray-900 font-bold mb-3">Key Industries in {loc.city}</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <h3 className="text-gray-900 font-bold mb-3">Key Business Areas</h3>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-5 text-center shadow-sm">
                  ...
                  <div className="text-gray-500 text-xs">Avg. Ranking Result</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              <Link
                ...
                className="group bg-white border border-gray-200 hover:border-[#4361ee] rounded-2xl p-7 transition-all hover:shadow-md"
              >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Also Serving Nearby Cities</h2>
